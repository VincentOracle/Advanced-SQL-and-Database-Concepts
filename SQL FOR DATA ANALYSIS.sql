...
/*Exercise 1.1:  MySQL AVG() function*/
SELECT 
    AVG(buyprice) 'Average Price'
FROM
    products;
/*Using MySQL AVG() function with a WHERE clause example*/
SELECT 
...
Views
a)Exercise 5.1: How to create an updatable view and update data in the underlying tablethrough the view8*/
...
a.Exercise 6.1: How to develop the first MySQL stored procedure using CREATE PROCEDURE statement8*/
...
/*Exercise 7.1: How to Return Multiple Values in stored procedure*/
DELIMITER $$
